...
def test_cellar_discard_one(turn: Turn, player: Player, monkeypatch):
...
def test_cellar_discard_multiple(turn: Turn, player: Player, monkeypatch):
    player.hand.add(cellar)
    player.hand.add(copper)
    player.hand.add(copper)
...
def test_cellar_empty_hand(turn: Turn, player: Player):
    player.hand.add(cellar)
    player.hand.cards[0].play(turn, player)
...
def test_cellar_discard_none(turn: Turn, player: Player, monkeypatch):
    player.hand.add(cellar)
